...
public class RunStockMarketApplication
{
    public static void main(String[] args) {
    	...
    	try {
			...
			List<Integer> custID = app.getCustomersWhoSoldManyStocks(numDifferentStocksSold);
			 ...
			 */
			String brenter = "LSE   ";
			System.out.println("\n---Number of Stocks that were affected by Brexit with the exchangeID of `"+ brenter +"`---");
			System.out.println(app.updateQuotesForBrexit(brenter));

			/**
			 * Output of rewardBestBuyers method
			 * First test having parameters theCount = 2 and theSellerID = 1456
			 * Second test having theCount = 4 and theSellerID = 1456
			 */
			
			System.out.println("\n---TEST 1 of rewardBestBuyers with theCount = 2 and theSellerID = 1456--- ");
			System.out.println(app.rewardBestBuyers(1456, 2));

			System.out.println("\n---TEST 2 of rewardBestBuyers with theCount = 4 and theSellerID = 1456--- ");
			System.out.println(app.rewardBestBuyers(1456, 4));
